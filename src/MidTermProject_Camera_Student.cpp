...
int main(int argc, const char *argv[])
{
    ...
    for (size_t imgIndex = 0; imgIndex <= imgEndIndex - imgStartIndex; imgIndex++)
    {
        ...
        //// STUDENT ASSIGNMENT
        //// TASK MP.2 [Done] -> add the following keypoint detectors in file matching2D.cpp and enable string-based selection based on detectorType
        ...
        //// STUDENT ASSIGNMENT
        //// TASK MP.4 [Done] -> add the following descriptors in file matching2D.cpp and enable string-based selection based on descriptorType
